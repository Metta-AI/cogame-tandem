...
# Substitute: tandem, coworld-tandem, 2.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-tandem:ci)
#   SMOKE_SLUG                 game slug                        (tandem)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/tandem)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/tandem-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-tandem:ci}}"
slug="${SMOKE_SLUG:-tandem}"
